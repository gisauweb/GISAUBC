...
export const ScrollButtonContainer = ({ threshold }) => {
	...
	return (
		...
		>
			<div
				className='w-10 h-10 sm:w-12 sm:h-12 flex justify-center items-center rounded-full border-2 border-primary bg-red-100 hover:cursor-pointer'
				onClick={scrollToTop}
			>
