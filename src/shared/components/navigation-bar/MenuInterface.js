  ...
  return (
    <div className={className}>
      ...
      >
        ...
        >
          <span
            className={`menu-line-1 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-l-sm duration-500 origin-[right_center] ${menuIconColor} ${
              isOpen && "translate-y-2 rotate-45"
            }`}
          ></span>
          <span
            className={`menu-line-2 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-l-sm duration-500 origin-[right_center] ${menuIconColor} ${
              isOpen && "scale-0"
            }`}
          ></span>
          <span
            className={`menu-line-3 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-l-sm duration-500 origin-[right_center] ${menuIconColor} ${
              isOpen && "-translate-y-2 -rotate-45"
            }`}
          ></span>
          <span
            className={`menu-line-4 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-r-sm duration-500 origin-[left_center] ${menuIconColor} ${
              isOpen && "translate-y-2 -rotate-45"
            }`}
          ></span>
          <span
            className={`menu-line-5 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-r-sm duration-500 origin-[left_center] ${menuIconColor} ${
              isOpen && "scale-0"
            }`}
          ></span>
          <span
            className={`menu-line-6 w-3 h-[2px] mt-[3px] mb-[3px] block rounded-r-sm duration-500 origin-[left_center] ${menuIconColor} ${
              isOpen && "-translate-y-2 rotate-45"
            }`}
          ></span>
        </div>
