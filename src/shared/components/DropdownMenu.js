...
const DropdownMenu = ({selectedYear, setSelectedYear}) => {
    ...
    return (
        <div className="w-40 sm:w-64 absolute sm:right-24 lg:right-48 mt-16 sm:mt-1 rounded-2xl border-2 border-spacing-2 border-primary stroke-primary" ref={dropdownRef}>
            <button
                type="button"
