...
const Activities = () => {
  ...
  return (
    <Box className="pt-24">
      <Box className="w-full flex items-center pl-6 lg:pl-0 lg:pb-3 mb-6 lg:mb-0">
        <span className="text-xl sm:text-2xl xl:text-4xl font-medium font-oswald text-primary">
          WHAT WE DO
        </span>
        <img
          src={smiley}
