    ...
    <div className={`h-screen justify-center items-center`}>
      ...
      <div className="relative flex justify-center items-center h-full">
        <div className="w-full mt-1/10">
          ...
          ></img>
          <h1 className="text-white my-4 md:my-8 mx-2 font-proxima-nova text-center font-semibold text-lg sm:text-2xl md:text-4xl lg:text-[2.5rem] lg:leading-12">
            Gado-Gado Indonesian Student Association {!isMobileView && <br />}{" "}
            of UBC
          </h1>
          <CustomButton className="grid justify-center" />
        </div>
      </div>
    </div>
  );
