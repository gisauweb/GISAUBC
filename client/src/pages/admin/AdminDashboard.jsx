const SECTIONS = [
	{
		id: 'Members',
		label: 'Members',
		description: 'View and edit all registered members.',
		icon: '👥',
	},
	{
		id: 'Cash Payments',
		label: 'Cash Payments',
		description: 'Approve pending cash payments.',
		icon: '💵',
	},
	{
		id: 'Events',
		label: 'Events & Rantangan',
	...
	},
	{
		...
		description: 'See who signed up for each event.',
		icon: '🎟️',
	},
	{
		id: 'Existing Members',
		label: 'Existing Members',
		description: 'Manage pre-approved student IDs.',
		icon: '🎓',
	},
	{
		id: 'Merch',
		label: 'Merch',
		description: 'Manage merch items and purchases.',
		icon: '👕',
	},
];

export default function AdminDashboard({ profile, setCurrentPage }) {
	return (
		<div className='p-8'>
			<div className='mb-8'>
