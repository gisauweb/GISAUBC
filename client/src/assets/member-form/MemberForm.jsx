...
import { Box, Typography, TextField, Radio, RadioGroup, FormControlLabel, Checkbox, Select, MenuItem, InputLabel, FormControl } from '@mui/material';
import GisauLogo from 'assets/gisau-logo/gisau_white.svg'; // Adjust path if needed
import Batik from './Batik.png';

// --- Constants ---
const FACULTIES = ['Arts', 'Science', 'Engineering', 'Sauder', 'Land & Food Systems', 'Kinesiology', 'Forestry', 'Other'];
...
export default function MemberForm() {
    ...
    const renderStep1 = () => (
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        style={{ backgroundImage: 'url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%22%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23000000%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E")', backgroundRepeat: 'no-repeat', backgroundPosition: 'right 1rem center', backgroundSize: '0.80em' }}
                    >
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">What foods or events are you looking forward for GISAU to host? We will try make it happen!</label>
                <textarea
                    {...register('food')}
                ...
                <div className="space-y-2">
                    {MEMBERSHIP_TYPES.map((type) => (
                        <label key={type.id} className="flex items-center space-x-3 cursor-pointer">
                            ...
                            />
                            <span className="text-sm text-gray-700">{type.label} = ${type.price}</span>
                        </label>
                    ))}
                </div>
            </div>
        ...
        return (
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
                    ...
                    <div className="space-y-3">
                        {MERCHANDISE.map((item) => (
                            <label key={item.id} className="flex items-center space-x-3 cursor-pointer">
                                ...
                                />
                                <span className="text-gray-700">{item.label} (+${item.price})</span>
                            </label>
                        ))}
                ...
                <div className="w-full md:w-96 bg-gray-100 p-6 rounded-sm h-fit">
                    <h3 className="text-lg font-bold font-oswald uppercase mb-4 tracking-wider border-b border-black pb-2">ORDER SUMMARY</h3>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {watch('paymentMethod') === 'etransfer' ? (
                <div className="bg-[#F0F4FA] p-8 rounded-lg mb-8">
                    ...
                    <p className="text-gray-600 text-sm italic mb-6">Example: "Joko Widodo, 12345678, GISAU Full Year Membership"</p>

                    <p className="font-bold text-sm mb-4">Upload your proof of payment (screenshot or confirmation) to this form once your transfer is complete.</p>
        ...
        <div className="flex flex-col items-center justify-center min-h-[50vh]">
            <div className="bg-white p-12 rounded-xl shadow-lg text-center max-w-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-8 text-sm">
                    Your membership registration has been submitted successfully.<br />
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#FFFDF5] relative overflow-hidden">
            {/* Header */}
            <div className="bg-[#732727] h-24 w-full flex justify-between items-center px-8 shadow-md z-20">
                <div onClick={() => navigate('/')} className="cursor-pointer">
                    <img src={GisauLogo} alt="GISAU Logo" className="h-14 w-auto" />
                </div>
