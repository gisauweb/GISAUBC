      ...
      <div className="flex lg:flex-row flex-col w-full gap-5 pb-10 md:pb-36">
        <div className="w-full lg:w-1/3 h-auto bg-bgCream p-7 rounded-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Typography variant="body1">
              Your brand will be prominently featured throughout the academic
              year at our diverse range of events, ensuring exposure to a broad
              audience of UBC students, faculty, and the wider Vancouver
              community.
            </Typography>
          </div>
        </div>
        <div className="w-full lg:w-1/3 h-auto bg-bgCream p-7 rounded-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Typography variant="body1">
              Align your brand with a vibrant, culturally rich student
              organization. As a partner, you gain access to a niche market
              passionate about Indonesian culture, education, and student life,
        ...
        <div className="w-full lg:w-1/3 h-auto bg-bgCream p-7 rounded-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Typography variant="body1">
              By partnering with GISAU, you&apos;re playing a vital role in
              enriching the student experience at UBC. Your support helps bridge
              cultural divides, fosters inclusivity, and contributes to a
